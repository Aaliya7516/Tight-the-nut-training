...
export class AuthService {
  ...
  login(log:login): Observable<any>{
    return this.httpClient.post("http://localhost:5000/login",log)
  }

  verify(veri:verify): Observable<any>{
    return this.httpClient.post("http://localhost:5000/verifyotp",veri)
  }

  resendotp(res:login): Observable<any>{
    return this.httpClient.post("http://localhost:5000/resendotp_web",res)
  }
  
  register(reg:register): Observable<any>{
    return this.httpClient.post("http://localhost:5000/register",reg)
  }
